				...
				<div class="tab-content">
					<div class="tab-pane active" id="home">
						<form class="form" action="##" method="post" id="registrationForm">
							...
							<div class="form-group">
								<div class="col-xs-6">
									<label><h4>Student's Mobile No</h4></label>
					...
					<div class="tab-pane" id="academic">
						...
						<div class="form-group">
							<div class="col-xs-6">
								...
								<input type="text" class="form-control" id="txtStuClass" />
                            </div>
						</div>
						...
						<div class="form-group">
							<div class="col-xs-6">
								...
								<input type="text" class="form-control" id="txtStuSection"/>
                            </div>
						</div>

						<div class="form-group">
							<div class="col-xs-6">
								<label for="phone"><h4>Stream</h4></label>
								<input type="text" class="form-control" id="txtStuStream" />
                            </div>
						</div>
